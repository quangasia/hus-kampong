 ...
 */
class MediaManager implements ObjectManagerInterface {
    /**
    ...
    public function getRepository() {
        return $this->entityManager->getRepository('AseagleBackend:Media');
    }
    ...
    public function createObject() {
        return new \Aseagle\Backend\Entity\Media();
    }
