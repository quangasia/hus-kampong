 ...
 */
class CommentManager implements ObjectManagerInterface {
    /**
    ...
    public function getRepository() {
        return $this->entityManager->getRepository('AseagleBackend:Comment');
    }
    ...
    public function createObject() {
        return new \Aseagle\Backend\Entity\Comment();
    }
